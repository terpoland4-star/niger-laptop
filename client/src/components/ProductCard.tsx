    ...
    <div className="group relative h-full flex flex-col bg-card rounded-lg overflow-hidden border border-border card-interactive card-gradient-border">
      ...
      <div className="flex-1 flex flex-col p-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          {/* WhatsApp — canal de discussion, pas une commande */}
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="w-full font-medium py-1.5 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 text-xs opacity-90"
          >
